...
5.  **Notice Compensation**: If notice is unserved during a resignation, compensation equal to the wage for the unserved notice period is owed, recorded as a **separate settlement line** — never deducted from the EOSB (gratuity) total.
